...
public class Ex10_2 {
    public static void main(String[] args) {
        ...
        // month의 경우 0부터 시작하므로 4월인 경우 3으로 지정해야함
        // date1.set(2019, Calendar.APRIL, 29); 와 같이 할 수도 있음
        date1.set(2020, 10, 21); // 2020년 11월 21일로 날짜 설정
        System.out.println("1일(date1)은 " + toString(date1) + DAY_OF_WEEK[date1.get(Calendar.DAY_OF_WEEK)] + "요일이고, ");
        System.out.println("오늘(date2)는 " + toString(date2) + DAY_OF_WEEK[date2.get(Calendar.DAY_OF_WEEK)] + "요일입니다.");

        // 두 날짜간의 차이를 얻으려면 getTimeInMillis() 1000분의 1초 단위로 변환해야함
